...
type Querier interface {
	...
	GetUserWishlistTrains(ctx context.Context, arg GetUserWishlistTrainsParams) ([]WishlistTrain, error)
	...
	ListUserCollectionTrains(ctx context.Context, arg ListUserCollectionTrainsParams) ([]CollectionTrain, error)
	...
	ListWishlistTrains(ctx context.Context, arg ListWishlistTrainsParams) ([]WishlistTrain, error)
