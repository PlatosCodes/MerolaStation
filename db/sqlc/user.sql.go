...
INSERT INTO users (
  ...
  $1, $2, $3
) RETURNING id, username, email, hashed_password, activated, password_changed_at, version, created_at
`
...
SELECT id, username, email, hashed_password, activated, password_changed_at, version, created_at FROM users
WHERE id = $1 LIMIT 1
`
